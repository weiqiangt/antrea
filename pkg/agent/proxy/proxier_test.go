...
func testClusterIP(t *testing.T, svcIP net.IP, epIP net.IP, isIPv6 bool) {
	...
	mockRouteClient.EXPECT().AddService(svcIP, uint16(svcPort), bindingProtocol).Times(1)
...
func TestLoadbalancer(t *testing.T) {
	...
	mockRouteClient.EXPECT().AddService(svcIPv4, uint16(svcPort), binding.ProtocolTCP).Times(1)
	mockRouteClient.EXPECT().AddService(loadBalancerIPv4, uint16(svcPort), binding.ProtocolTCP).Times(1)
...
func TestExternalNameToNodePort(t *testing.T) {
	...
	mockRouteClient.EXPECT().AddService(svcIPv4, uint16(svcPort), bindingProtocol)
	mockRouteClient.EXPECT().AddNodePortService(gomock.Any(), gomock.Any(), false).Times(1)
...
func testClusterIPRemoval(t *testing.T, svcIP net.IP, epIP net.IP, isIPv6 bool) {
	...
	mockRouteClient.EXPECT().DeleteService(svcIP, uint16(svcPort), bindingProtocol).Times(1)
...
func testClusterIPRemoveSamePortEndpoint(t *testing.T, svcIP net.IP, epIP net.IP, isIPv6 bool) {
	...
	mockRouteClient.EXPECT().AddService(svcIP, uint16(svcPort), protocolTCP).Times(1)
	mockRouteClient.EXPECT().AddService(svcIP, uint16(svcPort), protocolUDP).Times(1)
...
func testPortChange(t *testing.T, svcIP net.IP, epIP net.IP, isIPv6 bool) {
	...
	mockRouteClient.EXPECT().AddService(svcIP, uint16(svcPort1), bindingProtocol).Times(1)
	mockOFClient.EXPECT().UninstallServiceFlows(svcIP, uint16(svcPort1), bindingProtocol)
	mockRouteClient.EXPECT().DeleteService(svcIP, uint16(svcPort1), bindingProtocol).Times(1)
	mockOFClient.EXPECT().InstallServiceFlows(groupID, svcIP, uint16(svcPort2), bindingProtocol, uint16(0))
	mockRouteClient.EXPECT().AddService(svcIP, uint16(svcPort2), bindingProtocol).Times(1)
...
func TestServicesWithSameEndpoints(t *testing.T) {
	...
	mockRouteClient.EXPECT().AddService(svcIP1, uint16(svcPort), bindingProtocol).Times(1)
	mockRouteClient.EXPECT().AddService(svcIP2, uint16(svcPort), bindingProtocol).Times(1)
	...
	mockRouteClient.EXPECT().DeleteService(svcIP1, uint16(svcPort), bindingProtocol).Times(1)
	mockRouteClient.EXPECT().DeleteService(svcIP2, uint16(svcPort), bindingProtocol).Times(1)
