...
// ensureRule checks if target rule already exists, add it if not. If prepend is true, the rule will be added to the top of
// the chain. Otherwise, the rule will be appended to the chain.
