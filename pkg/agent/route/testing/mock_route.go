...
func (m *MockInterface) AddNodePort(nodeIPs []net.IP, svcInfo *types.ServiceInfo, isIPv6 bool) error {
	m.ctrl.T.Helper()
...
func (m *MockInterface) AddNodePortRoute(bool) error {
	m.ctrl.T.Helper()
...
func (m *MockInterface) DeleteNodePort(nodeIPs []net.IP, svcInfo *types.ServiceInfo, isIPv6 bool) error {
	m.ctrl.T.Helper()
