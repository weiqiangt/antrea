...
// versionTransform is the AddonTransform for the version command. It will populate
// the version of component and the version of the antctl to a versionResponse.
...
// CommandList defines all commands could be used for the antctl for both agent
...
// Server describes actions of an antctl server.
type Server interface {
	...
	// use the value of AgentMonitor and Controller monitor to know which
