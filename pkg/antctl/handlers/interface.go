...
type Factory interface {
	// Handler creates net/http.HandlerFunc which will be used to handle
	// the requests issued by commands from the antctl client. The implementation
	...
	// the ControllerQuerier will not be nil.
