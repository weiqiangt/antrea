...
type commandDefinition struct {
	...
	// ResponseStruct is the response object data struct of the command. This
	// struct is no need to be used for the response struct of the handler if
	// a AddonTransform is set.
