...
// handler with path /<api prefix>. Since the antctl service contains only non-resource
...
// renderDescription replaces placeholder ${component} in Short and Long of a command
