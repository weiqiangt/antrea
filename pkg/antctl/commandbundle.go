...
func (b *CommandBundle) ApplyToRouter(r *mux.PathRecorderMux, aq monitor.AgentQuerier, cq monitor.ControllerQuerier) {
	...
	// TODO: Replace this statement by using API provided by K8s
...
func (b *CommandBundle) ApplyToAPIServer(server *server.GenericAPIServer, cq monitor.ControllerQuerier) error {
