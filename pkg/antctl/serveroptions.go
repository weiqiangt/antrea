...
// ServerOptions defines all options of a antctl server.
...
func StartServer(opts *ServerOptions, commandList *commandList, aq monitor.AgentQuerier, cq monitor.ControllerQuerier, stopCh <-chan struct{}) <-chan struct{} {
