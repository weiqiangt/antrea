...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.AddressGroup":                schema_antrea_pkg_apis_networking_AddressGroup(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.AddressGroupList":            schema_antrea_pkg_apis_networking_AddressGroupList(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.AddressGroupPatch":           schema_antrea_pkg_apis_networking_AddressGroupPatch(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.AppliedToGroup":              schema_antrea_pkg_apis_networking_AppliedToGroup(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.AppliedToGroupList":          schema_antrea_pkg_apis_networking_AppliedToGroupList(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.AppliedToGroupPatch":         schema_antrea_pkg_apis_networking_AppliedToGroupPatch(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.IPBlock":                     schema_antrea_pkg_apis_networking_IPBlock(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.IPNet":                       schema_antrea_pkg_apis_networking_IPNet(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicy":               schema_antrea_pkg_apis_networking_NetworkPolicy(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyList":           schema_antrea_pkg_apis_networking_NetworkPolicyList(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyPeer":           schema_antrea_pkg_apis_networking_NetworkPolicyPeer(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyRule":           schema_antrea_pkg_apis_networking_NetworkPolicyRule(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.PodReference":                schema_antrea_pkg_apis_networking_PodReference(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/networking.Service":                     schema_antrea_pkg_apis_networking_Service(ref),
...
func schema_antrea_pkg_apis_networking_AddressGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"IPAddresses": {
						SchemaProps: spec.SchemaProps{
							Description: "IPAddresses is a list of IP addresses selected by this group.",
							Type:        []string{"array"},
				...
				Required: []string{"TypeMeta", "ObjectMeta", "IPAddresses"},
			},
		},
		Dependencies: []string{
...
func schema_antrea_pkg_apis_networking_AddressGroupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"Items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.AddressGroup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.AddressGroup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}

func schema_antrea_pkg_apis_networking_AddressGroupPatch(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"TypeMeta", "ObjectMeta", "AddedIPAddresses", "RemovedIPAddresses"},
			},
		},
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
...
func schema_antrea_pkg_apis_networking_AppliedToGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"Pods": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.PodReference"),
									},
								},
							},
						},
				...
				Required: []string{"TypeMeta", "ObjectMeta", "Pods"},
			},
		},
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.PodReference", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}

func schema_antrea_pkg_apis_networking_AppliedToGroupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"Items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.AppliedToGroup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.AppliedToGroup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}

func schema_antrea_pkg_apis_networking_AppliedToGroupPatch(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"TypeMeta", "ObjectMeta", "AddedPods", "RemovedPods"},
			},
		},
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.PodReference", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
...
func schema_antrea_pkg_apis_networking_IPBlock(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"CIDR": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.IPNet"),
						},
					},
					"Except": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.IPNet"},
	}
}

func schema_antrea_pkg_apis_networking_IPNet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_antrea_pkg_apis_networking_NetworkPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"Rules": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyRule"),
									},
								},
							},
						},
				...
				Required: []string{"TypeMeta", "ObjectMeta", "Rules", "AppliedToGroups"},
			},
		},
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyRule", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}

func schema_antrea_pkg_apis_networking_NetworkPolicyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"Items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicy"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicy", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}

func schema_antrea_pkg_apis_networking_NetworkPolicyPeer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"IPBlocks": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.IPBlock"),
									},
								},
							},
						},
				...
				Required: []string{"AddressGroups", "IPBlocks"},
			},
		},
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.IPBlock"},
	}
}

func schema_antrea_pkg_apis_networking_NetworkPolicyRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"From": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyPeer"),
						},
					},
					"To": {
						SchemaProps: spec.SchemaProps{
					...
					"Services": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/networking.Service"),
									},
								},
							},
						},
				...
				Required: []string{"Direction", "From", "To", "Services"},
			},
		},
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking.NetworkPolicyPeer", "github.com/vmware-tanzu/antrea/pkg/apis/networking.Service"},
	}
}

func schema_antrea_pkg_apis_networking_PodReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_antrea_pkg_apis_networking_Service(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"Port": {
						SchemaProps: spec.SchemaProps{
							Description: "The port on the given protocol. If not specified, this matches all port numbers.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_pkg_apis_networking_v1beta1_AppliedToGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/networking/v1beta1.PodReference", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
